...
function LoginContent() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 items-start max-w-4xl w-full relative z-10">
      ...
      {/* Quick Access Panel */}
      <div className="w-full max-w-sm bg-neuro-navy rounded-[3rem] p-8 text-white shadow-2xl border border-white/10 self-stretch flex flex-col">

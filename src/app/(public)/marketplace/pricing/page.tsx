        ...
        <div className="text-center mb-20 space-y-6">
           ...
           <div className="flex items-center justify-center gap-4 mt-12 mb-10">
             ...
             <button 
               ...
               className="w-14 h-7 bg-white border border-gray-200 rounded-full relative p-1 transition-colors hover:bg-gray-50"
             >
               <motion.div 
             ...
             <div className="flex items-center gap-2">
               ...
               <span className="bg-green-100 text-green-700 text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-tighter border border-green-200">2 Months Free</span>
             </div>
           </div>
        </div>

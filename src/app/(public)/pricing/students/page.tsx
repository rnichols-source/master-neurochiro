  ...
  return (
    <div className="space-y-12">
      ...
      <div className="flex items-center justify-center gap-4 mb-10">
        <span className={cn("text-xs font-black uppercase tracking-widest", billingCycle === 'monthly' ? 'text-neuro-navy' : 'text-gray-400')}>Monthly</span>
        <button 
        ...
        <div className="flex items-center gap-2">
          <span className={cn("text-xs font-black uppercase tracking-widest", billingCycle === 'annual' ? 'text-neuro-navy' : 'text-gray-400')}>Annual</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch mx-auto max-w-7xl">
        {studentTiers.map((tier) => (
          ...
          >
            ...
            <Link 
              href={tier.id === 'free' ? '/register?role=student&tier=free' : STRIPE_PAYMENT_LINKS.student[tier.id as keyof typeof STRIPE_PAYMENT_LINKS.student][billingCycle]}
              className={cn(

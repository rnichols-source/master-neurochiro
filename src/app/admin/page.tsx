    ...
    return (
      <DashboardLayout>
        <AdminDashboardClient 
          ...
          initialMastermindActivity={mastermind?.success ? mastermind.data : null}
          initialRevenueData={revenue?.success ? revenue.data : null}
          initialAtRisk={atRisk?.success ? atRisk.data : []}
          initialVaultStats={vault?.success ? vault.data : []}
          initialHealth={health?.success ? health.data : null}
        />
      </DashboardLayout>
    );
  } catch (err) {

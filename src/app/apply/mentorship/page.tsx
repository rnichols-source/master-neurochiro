...
export const metadata = {
  title: "Apply for Private Coaching | NeuroChiro Mastermind",
  description: "Apply for 1-on-1 private coaching with Dr. Raymond Nichols. Three tiers available.",
};
      ...
      <div className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center mb-12 space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-brand-navy tracking-tighter leading-none">
            Clinic Diagnostic <br /><span className="text-brand-orange">& Coaching Application.</span>
          </h1>
        ...
        <Suspense fallback={<div className="text-center py-20 text-brand-gray">Loading application...</div>}>

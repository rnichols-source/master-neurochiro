...
export default function ApplicationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.full_name || !formData.email || !formData.phone || !formData.current_role) {
    ...
    return (
      <div className="min-h-screen bg-brand-cream flex items-center justify-center p-6">
        ...
        >
          ...
          <Link href="/">
            <BrandButton variant="outline">Back to Home</BrandButton>
          </Link>
        </motion.div>
      </div>
    );
        ...
        <div className="max-w-xl mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-base text-brand-gray font-medium">
              Tell us a little about yourself and your practice. Takes less than
              2 minutes.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-white border border-brand-navy/10 rounded-xl py-4 px-5 text-base font-medium text-brand-navy focus:border-brand-orange/40 transition-all outline-none"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full bg-white border border-brand-navy/10 rounded-xl py-4 px-5 text-base font-medium text-brand-navy focus:border-brand-orange/40 transition-all appearance-none outline-none"
              >
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-white border border-brand-navy/10 rounded-xl py-4 px-5 text-base font-medium text-brand-navy focus:border-brand-orange/40 transition-all outline-none resize-none"
              />
            </div>
            ...
            <div className="flex items-center justify-center gap-2 text-sm text-brand-gray font-medium">
              <CheckCircle2 className="w-4 h-4 text-brand-gray/40" />
              <span>We review every application personally within 48 hours</span>
            </div>
          </form>
        </div>
      </section>

...
export function LivePricing({ event }: LivePricingProps) {
  ...
  return (
    <section id="pricing" className="section-padding bg-brand-navy relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-orange/5 rounded-full blur-[100px]" />
      
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="text-center mb-16 space-y-4">
          <p className="text-brand-orange font-black uppercase tracking-[0.4em] text-[10px]">Investment</p>
          <h2 className="text-7xl font-black text-white tracking-tighter leading-none">Secure Your Seat.</h2>
          <p className="text-xl text-white/40 font-medium">Limited to {event.max_capacity} seats for absolute focus and interaction.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {innerCircleTicket && (
            ...
            >
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-brand-orange text-white text-[10px] font-black uppercase tracking-widest px-6 py-2 rounded-full shadow-lg shadow-brand-orange/30">
                Highly Limited
              </div>
              <div className="flex items-center gap-3 mb-8">
              ...
              <BrandButton 
                ...
                isLoading={loading === "inner_circle"}
              >

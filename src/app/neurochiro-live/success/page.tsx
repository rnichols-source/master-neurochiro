      ...
      <div className="max-w-2xl w-full glass-panel p-12 md:p-20 rounded-[4rem] text-center space-y-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-none mb-6">
            Seat <br /><span className="text-gradient">Secured.</span>
          </h1>
          ...
          <div className="flex items-center justify-center gap-3 text-white/40 mb-12">
            <Mail className="w-4 h-4" />
            <span className="text-xs font-bold uppercase tracking-widest">Confirmation email sent</span>
          </div>

          <Link href="/">
            <BrandButton variant="outline" className="w-full border-white/10 text-white hover:bg-white/5 py-6 rounded-2xl">
              Back to NeuroChiro
            </BrandButton>
          </Link>
        </div>

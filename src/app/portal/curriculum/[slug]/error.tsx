  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-black text-brand-navy tracking-tight">Phase Access Error</h1>
        <p className="text-brand-gray max-w-md mx-auto">
          We encountered a technical issue while loading this curriculum phase. 
          This is often due to a temporary database sync issue.
        </p>
        {error.digest && (

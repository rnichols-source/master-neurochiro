...
import { fetchScorecard } from "@/app/actions/scorecard-actions";
...
export default async function ScorecardPage() {
          ...
          <EliteCard className="max-w-xl p-12 text-center space-y-8 bg-brand-navy text-white border-none shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/60 font-medium leading-relaxed">
                The Practice Scorecard compares your KPIs against the group and provides personalized coaching recommendations. This tool is reserved for Pro members.
              </p>
            </div>
  ...
  const result = await fetchScorecard();

  return (
    <DashboardLayout>
      <ScorecardClient data={result.success ? result.data : undefined} />
    </DashboardLayout>
  );
}

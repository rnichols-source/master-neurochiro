...
import { ProVaultClient } from "./ProVaultClient";
          ...
          <EliteCard className="max-w-xl p-12 text-center space-y-8 bg-brand-navy text-white border-none shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/60 font-medium leading-relaxed">
                The Pro Resource Vault contains practice templates, contracts, scripts, and financial tools. This is reserved for Pro members.
              </p>
            </div>

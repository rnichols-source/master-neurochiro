          ...
          <div className="relative space-y-16">
            ...
            <div className="relative pl-16">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] font-bold text-brand-gray uppercase tracking-[0.2em]">Goal: Ease the money tension immediately.</p>
            ...
            <div className="relative pl-16">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] font-bold text-brand-gray uppercase tracking-[0.2em]">Goal: Show them what happens if they walk away.</p>
                <div className="p-8 bg-brand-cream border-l-8 border-brand-orange italic font-bold text-xl text-brand-navy leading-relaxed shadow-sm">
                  "{script.step2}"
                </div>
              </div>
            ...
            <div className="relative pl-16">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] font-bold text-brand-gray uppercase tracking-[0.2em]">Goal: Put them in the driver's seat.</p>
            ...
            <div className="border-t-2 border-brand-navy/10 pt-16">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-orange">Pro Execution Tip</h4>
              </div>
            ...
            <div className="mt-20 pt-10 border-t-4 border-brand-navy flex justify-between items-end">
              <div className="space-y-2">
                ...
                <p className="text-[8px] font-bold text-brand-gray uppercase tracking-widest">© 2026 Internal Use Only. One saved case pays for your month. Go execute.</p>
              </div>

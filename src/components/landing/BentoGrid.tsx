        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[400px]">
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-4">
              <Link href="/directory" className="flex items-center gap-2 text-white font-bold group-hover:text-neuro-orange transition-colors">
                Find a Doctor <ArrowUpRight className="w-5 h-5" />
              </Link>
            </div>
          </motion.div>
          ...
          >
             <div className="absolute -right-10 -top-10 w-40 h-40 bg-neuro-orange/10 rounded-full blur-3xl transition-opacity group-hover:opacity-100 opacity-50" />
            ...
            <Link href="/seminars" className="flex items-center gap-2 text-neuro-navy font-bold group-hover:translate-x-1 transition-transform">
              Find a Seminar <ArrowUpRight className="w-5 h-5" />
            </Link>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
               <Link href="/register?role=student" className="px-8 py-4 bg-white text-neuro-navy rounded-full font-bold hover:bg-gray-100 transition-colors">
                 Join as Student
               </Link>
            </div>
          </motion.div>

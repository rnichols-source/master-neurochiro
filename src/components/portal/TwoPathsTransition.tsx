          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-[10px] font-bold text-brand-navy/40 uppercase tracking-widest">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-2 py-0.5 bg-brand-navy/10 rounded-full text-brand-navy border border-brand-navy/10 mb-2">
                <p className="text-[8px] font-black uppercase tracking-widest">Community Implementation</p>
              </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-[10px] font-bold text-brand-navy uppercase tracking-widest">
        ...
        <EliteCard className="p-8 border-brand-orange/20 bg-brand-navy text-white flex flex-col justify-between relative overflow-hidden shadow-2xl">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-2 py-0.5 bg-brand-orange/20 rounded-full text-brand-orange border border-brand-orange/30 mb-2">
                <p className="text-[8px] font-black uppercase tracking-widest">Executive Mentorship</p>
              </div>
          ...
          <div className="pt-10 relative z-10">
            <Link href="/mentorship">
              <BrandButton variant="accent" className="w-full text-[10px] group shadow-xl shadow-brand-orange/20">

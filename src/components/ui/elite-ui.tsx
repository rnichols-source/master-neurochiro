...
export function BrandButton({
  ...
  const variants = {
    primary:
      "bg-brand-navy text-white hover:bg-brand-black shadow-lg shadow-brand-navy/20",
    outline:
    ...
    accent:
      "bg-brand-orange text-white hover:bg-[#B35520] shadow-lg shadow-brand-orange/20",
  };
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center font-bold uppercase tracking-widest rounded-xl transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed",
        variants[variant],
        sizes[size],
        className
      )}

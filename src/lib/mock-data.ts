...
export const MOCK_DOCTORS: Doctor[] = [
  ...
  },
  {
    ...
    "first_name": "",
    "last_name": "Sydney Oberstein-Tyrrell",
...
import { Student, Job, Seminar } from "@/types/directory";
...
export const MOCK_STUDENTS: Student[] = [
  ...
  { 
    ...
    interests: ["Sports", "Rehab"], 
    is_looking_for_mentorship: false,
    match_rate: 85,
    engagement_score: 82,
    region_code: "US"
  },
...
export const MOCK_JOBS: Job[] = [
  {
    id: "job_1",
    doctor_id: "bgahsu", // Dr. Amy Anthony
    title: "Associate Chiropractor",
    description: "Seeking a tonal-focused associate for our busy family practice.",
    location: "Olympia, WA",
    type: "associate",
  ...
  {
    id: "job_2",
    doctor_id: "9hm4ee", // Dr. Blain Segura
    title: "Clinic Director",
    description: "Experienced chiropractor needed to lead our new satellite clinic.",
    location: "Stuart, FL",
    type: "buy_in",
    salary_range: "$100k+",
    status: "open",
...
export const MOCK_SEMINARS: Seminar[] = [
  {
    id: "sem_1",
    host_id: "mkozoic", // Dr. Chandler Boggs
    title: "Vagal Tone Mastery",
    description: "Deep dive into nervous system regulation and tonal techniques.",
    date: "2025-11-15",
  ...
  {
    id: "sem_2",
    host_id: "ssubzr", // Dr. Stanton Hom
    title: "Future Gen Leadership Summit",
    description: "Leadership training for the next generation of chiropractors.",
    date: "2025-12-05",
